...
sheets.method.getRange(`A${weightStart + 2}:F${weightStart + 11}`).values = [
  ["GPA/均分", 0.20, "gpaPercent", "百分制", "学术基础", "可调"],
  ["年级排名", 0.10, "classRankPercentile", "100 - 百分位", "相对竞争环境", "可调"],
  ["课程难度", 0.12, "rigor", "1-5 转 20-100", "课程挑战度", "可调"],
  ["标化/语言", 0.13, "SAT/ACT/TOEFL/IELTS", "分段归一", "可比硬指标", "可调"],
  ...
  ["文书", 0.05, "essay", "1-5 转 20-100", "叙事成熟度", "可调"],
  ["推荐信", 0.05, "recommendations", "1-5 转 20-100", "第三方背书", "可调"]
];
