...
const profileRows = [
  ...
  ["基础", "申请轮次", "round", "EA / ED / RD", "必填", "学生输入", "申请策略修正、轮次门槛", "只有存在学校级轮次政策数据时才给 EA/ED 概率加分；UC 等限制走 gate"],
...
const probabilityRows = [
  ...
  ["轮次修正", "roundDelta", "ED/EA/RD", "logit 修正", "申请策略调节", "学生输入 + 学校规则", "缺少学校级轮次政策数据时不泛化加分；轮次限制仍由 gate 管"],
